...
//		popupMenuDemo = null;
	 ...
	 * (JMenu). Esta selección es un sombreado del menú (componente). Es diferente
	 * seleccionar que hacer click.
	 */
	@Test
...
//			System.out.println(menu.getText());
	...
	/**
	 * En este test se pretende probar que se hace click correctamente en un menú
	 * (JMenu). Al hacer click en el menú, este debe abrirse. Se debe comprobar que
	 * efectivamente se abre el menú..
	 */
	@Test
	...
	/**
	 * Este test pretende probar, cuando el cursor está por encima de un submenú (un
	 * JMenu dentro de otro JMenu), el submenú se abre correctamente. Se debe
	 * simular que colocas el cursor encima del componente. Se debe comprobar que el
